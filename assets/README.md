...
- The background music source is `Smooth Like Jazz` by Ahjay Stelino from Mixkit, used under Mixkit's Stock Music Free License.
- Sound effects are still generated with the Web Audio API in `main.js`.
